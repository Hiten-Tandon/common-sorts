...
pub fn u8_sorting_routine(arr: &mut [u8], len: usize) {
...
pub fn u16_sorting_routine(arr: &mut [u16], len: usize, mut max_ele: u16) {
    let mut exp: u8 = 0;
...
pub fn u32_sorting_routine(arr: &mut [u32], len: usize, mut max_ele: u32) {
    let mut exp: u8 = 0;
...
pub fn u64_sorting_routine(arr: &mut [u64], len: usize, mut max_ele: u64) {
    let mut exp: u8 = 0;
...
pub fn u128_sorting_routine(arr: &mut [u128], len: usize, mut max_ele: u128) {
    let mut exp: u8 = 0;
...
pub fn usize_sorting_routine(arr: &mut [usize], len: usize, mut max_ele: usize) {
    let mut exp: u8 = 0;
...
pub fn char_sorting_routine(arr: &mut [char], len: usize, max_ele: char) {
...
pub fn bool_sorting_routine(arr: &mut [bool]) {
    let mut false_count: usize = 0;
    let mut true_count: usize = 0;

    arr.iter()
        .for_each(|&b| if b { true_count += 1 } else { false_count += 1 });
...
pub fn string_sorting_routine(arr: &mut [String], len: usize, mut max_str_len: usize) {
    ...
    let arr_cpy: Vec<String> = arr_cpy
        .into_iter()
        .map(|ele| String::from_utf8(ele).expect("Invalid UTF-8 character"))
        .collect();
